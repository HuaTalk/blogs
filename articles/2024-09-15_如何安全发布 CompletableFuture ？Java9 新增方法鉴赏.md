---
title: "如何安全发布 CompletableFuture ？Java9 新增方法鉴赏"
date: 2024-09-15
url: https://juejin.cn/post/7414734229059764265
views: 230
likes: 3
collects: 2
source: html2md
...
# 如何安全发布 CompletableFuture ？Java9新增方法鉴赏

本文未经允许禁止转载。

Java9 对于CompletableFuture做了新的增强，除了万众期盼的[超时功能](<https://juejin.cn/post/7411345808527147062> "https://juejin.cn/post/7411345808527147062")（orTimeout），还有面向继承、安全发布的相关方法。本文中，我们将详细分析各个新增方法，同时说明其安全发布的重要性，最后提出相关的实践原则。
...
> 笔者曾在[《深入理解 Future, CompletableFuture, ListenableFuture，回调机制》](<https://juejin.cn/post/7388332481739882547> "https://juejin.cn/post/7388332481739882547")一文中质疑 CompletionStage#toCompletableFuture 方法破坏了接口设计的相关原则，CompletableFuture#minimalCompletionStage 不如直接使用接口。事实上，我当时还是没有理解Doug Lea（道哥）的设计思路。
> 
...
开源项目CFFU（功夫未来）对于CompletableFuture 进行了拓展，以下仅列举和Java9新增功能相关的拓展点：
  ...
  3. 提供了相关安全发布功能，比如[安全的超时功能](<https://juejin.cn/post/7411686792342274089> "https://juejin.cn/post/7411686792342274089")
  4. 内部的便利方法很多应用了保护性复制方法
